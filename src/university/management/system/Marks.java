...
public class Marks extends JFrame implements ActionListener{
	...
	Marks(String rollno){
		...
		JLabel heading = new JLabel("Vishveshwaraya TechnUniversity");
    	heading.setBounds(98,15,500,25);
    	heading.setFont(new Font("Tohona",Font.BOLD,20));
    	add(heading);
    	
    	JLabel subheading = new JLabel("Result of Examination 2024");
    	subheading.setBounds(100,50,500,20);
    	subheading.setFont(new Font("Tohona",Font.BOLD,18));
    	add(subheading);
    	
    	JLabel lblrollno = new JLabel("Roll Number :"+rollno);
    	lblrollno.setBounds(60,100,500,20);
    	lblrollno.setFont(new Font("Tohona",Font.PLAIN,20));
    	add(lblrollno);
    	
    	JLabel lblsemester = new JLabel();
    	lblsemester.setBounds(60,130,500,20);
    	lblsemester.setFont(new Font("Tohona",Font.PLAIN,18));
    	add(lblsemester);
    	
    	JLabel sub1 = new JLabel();
    	sub1.setBounds(100,200,500,20);
    	sub1.setFont(new Font("Tohona",Font.PLAIN,18));
    	add(sub1);
    	
    	JLabel sub2 = new JLabel();
    	sub2.setBounds(100,230,500,20);
    	sub2.setFont(new Font("Tohona",Font.PLAIN,18));
    	add(sub2);
    	
    	JLabel sub3 = new JLabel();
    	sub3.setBounds(100,260,500,20);
    	sub3.setFont(new Font("Tohona",Font.PLAIN,18));
    	add(sub3);
